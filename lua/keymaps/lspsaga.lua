...
k("n", "[E", function() require('lspsaga.diagnostic'):goto_prev({vd}) end)
k("n", "]E", function() require('lspsaga.diagnostic'):goto_next({vd}) end)
...
k({"n", "t"}, "<A-t>", "<cmd>Lspsaga term_toggle<CR>")
